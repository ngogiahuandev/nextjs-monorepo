...
export type UsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'UserEntity', createdAt: any, email: string, id: string, name: string, password: string, updatedAt: any }> };
